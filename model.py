...
model = pickle.load(open("model_rf_fix.pickle", "rb"))
model_info = pickle.load(open("model_rf_fix_info.pickle", "rb"))
...
st.write(
    f"**_Model's Accuracy_** :  :red[**{accuracy}**]% (:red[_Do not copy outright_])"
)
st.write("")
